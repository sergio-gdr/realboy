...
static Uint8 sgb_pack_buf[112];
static Uint8 sgb_tiles[256*32];
static Uint8 sgb_map[32*32];
static Uint8 sgb_att[32*32];
static long sgb_cur_cmd=-1;
static long sgb_cur_pack;
static long sgb_flag;
long sgb_mask;
static long sgb_cur_bit;
static long sgb_multi_player;
static long sgb_four_players;
static long sgb_next_ctrlr=0x0f;
static long sgb_reading_ctrlr;
static long sgb_cur_bit_shf;
static long sgb_state=IDLE;
static Uint32 sgb_scpal[512][4];
static Uint32 sgb_border_pal[64];
static Uint8 sgb_ATF[45][90];
